...
const faqs = [
  ...
  },
  {
    ...
    answer: `Yes, we take data safety seriously.
      ...
      - For **Guest Users**: If you use the "Continue as Guest" feature, your task data is stored locally in your browser's localStorage. This data is not transmitted to our servers and is only accessible from that specific browser. Clearing your browser's cache or site data will remove this local data.`,
  },
  {
  ...
  },
  {
    ...
    answer: `When you use the "Continue as Guest" feature, all the tasks and board configurations you create are stored in your web browser's local storage. This data is not saved on our servers. It will persist in that browser as long as you don't clear your browser's cache, cookies, or site-specific data. If you use a different browser or device, or if your browser data is cleared, the guest data will be lost.`,
  },
  {
  ...
  {
    question: "Are there any AI features in TaskGlide?",
