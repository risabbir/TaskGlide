        ...
        <div className="max-w-3xl mx-auto bg-card text-card-foreground p-6 sm:p-8 rounded-lg shadow-lg">
          ...
          <section className="mb-6">
            ...
            <p className="text-muted-foreground leading-relaxed mt-2">
              The "Continue as Guest" feature allows use of the Service with data stored in your browser's local storage. This data is not backed up by {APP_NAME} and may be lost if you clear your browser data or switch devices. A Guest ID is generated and stored locally to identify your guest session in that browser.
            </p>
          </section>
